...
def main() -> None:
    ...
    with tab_catsvc:
        ...
        # ==== MAINTENANCE BLOCK (UPDATED): keep your existing "Force Recompute ALL (override locks)" at the top; add Engine Probe, Integrity Self-Test, CKW Seed Coverage, CKW Stale Audit, Full CSV Backup ====
    with tab_maint:
